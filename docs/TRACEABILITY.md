...
| **BLD-009** | A failed build shall not replace the last known good PDF unless the new PDF was complet… | [`j_cancel`](../crates/biblecompose-app/tests/acceptance.rs) (+1 more) |
...
| **STY-005** | The GUI shall expose common style properties without requiring TOML editing. | [`resetting_a_style_restores_the_cascade`](../crates/biblecompose-tauri/tests/commands.rs) (+1 more) |
...
| **GUI-004** | The GUI shall provide a style editor for at least body paragraphs, poetry, section head… | [`editing_a_style_writes_the_sheet`](../crates/biblecompose-tauri/tests/commands.rs) (+1 more) |
...
| **GUI-009** | If integrated preview is unavailable on a platform, the application shall provide Open… | [`a_defaults_only`](../crates/biblecompose-app/tests/acceptance.rs) |
...
| **GUI-012** | The UI should remain responsive while parsing or typesetting by running long work off t… | [`j_cancel`](../crates/biblecompose-app/tests/acceptance.rs) |
